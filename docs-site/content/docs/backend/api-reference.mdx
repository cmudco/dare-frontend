...
- **Swagger UI**: [/api/docs/](/api/docs/) — Interactive API explorer with "Try it out" functionality
- **ReDoc**: [/api/redoc/](/api/redoc/) — Clean, readable API reference
- **OpenAPI Schema**: [/api/schema/](/api/schema/) — Raw JSON/YAML schema for code generation
