...
---
This document is the entry point for understanding how the backend is structured. For deeper component-level coverage, see [architecture/overview.md](/docs/backend/architecture-overview). For real-time event contracts, see [architecture/socketio-events.md](/docs/backend/socketio-events). For end-to-end request flows, see [architecture/data-flows.md](/docs/backend/data-flows).
...
See [architecture/socketio-events.md](/docs/backend/socketio-events) for the full event reference.
...
- **camelCase boundary** — REST responses are camelCase (handled by `djangorestframework-camel-case`); Python code stays snake_case. See [serialization.md](/docs/backend/serialization).

## Further reading

- [architecture/overview.md](/docs/backend/architecture-overview) — full component breakdown
- [architecture/data-flows.md](/docs/backend/data-flows) — sequence diagrams
- [architecture/socketio-events.md](/docs/backend/socketio-events) — real-time event reference
- [api/dare-backend.md](/docs/backend/api-reference) — REST API reference
