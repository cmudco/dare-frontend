...
- Use serializer field separation for read vs. write (see [docs/code-standards.md](/docs/backend/code-standards) and [docs/serialization.md](/docs/backend/serialization)).
