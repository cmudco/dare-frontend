...
The API will be available at `http://localhost:8000/`. Interactive Swagger docs are at `/api/docs/`.

> **Note:** Docker Compose currently provisions Weaviate and Ollama only. Postgres and Redis run on the host (see [INSTALL.md](/docs/backend/install) for full containerization).

## Quick Start (Bare Metal)

See [INSTALL.md](/docs/backend/install) for the full bare-metal deployment guide, including Postgres and Redis setup.
