...
- Vite's default asset fingerprinting + immutable cache headers in production (see [DEPLOYMENT.md](/docs/frontend/deployment)).
...
- [CONTRIBUTING.md](/docs/frontend/contributing) — coding standards and PR process
