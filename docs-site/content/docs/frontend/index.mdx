...
description: "React, TypeScript, routing, state, and UI structure for the Dietrich Analysis Research Education (DARE) Platform frontend."
---
...
See **[QUICKSTART.md](/docs/frontend/quickstart)** for the full local-setup walkthrough, and
**[DEPLOYMENT.md](/docs/frontend/deployment)** for building and serving `dist/` in production.
...
| Doc                                            | What's in it                                                         |
| ---------------------------------------------- | -------------------------------------------------------------------- |
| [QUICKSTART.md](/docs/frontend/quickstart)                 | Run the frontend locally — clone, install, configure, `npm run dev`  |
| [DEPLOYMENT.md](/docs/frontend/deployment)                 | Production deployment — build and serve `dist/`, with an optional Docker recipe |
