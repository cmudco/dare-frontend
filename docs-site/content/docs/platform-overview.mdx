...
description: "What DARE provides to users and how the frontend fits into the Dietrich Analysis Research Education Platform."
---
...
The DARE frontend is the primary user interface for the DARE platform. It connects to the `DARE backend` over REST and Socket.IO and gives users:
...
See [docs/architecture.md](/docs/frontend/architecture) for the full diagram and component breakdown.
...
| [docs/contributing.md](/docs/frontend/contributing) | Issues, pull requests, coding standards |
...
- `dare-backend` — Django REST + Socket.IO backend
- `socraticbooks-backend` — Educational platform that proxies to DARE
- `socraticbooks-react` — Educational platform frontend
