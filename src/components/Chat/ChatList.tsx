        ...
        <nav className="flex flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700 flex-grow ">
            ...
            {sessions.map((session) => (
                <div
                    ...
                    className={`flex items-center w-full p-3 leading-tight transition-all outline-none text-start cursor-pointer rounded-md ${location.pathname === `/chat/${session.session_id}`
