...
export default function NotesNode({ id, data, selected }: NodeProps) {
  ...
  return (
    <div
      className={`max-w-[280px] min-w-[180px] cursor-pointer rounded-lg border-2 border-yellow-300 bg-linear-to-br from-yellow-50 to-yellow-100 transition-all hover:-translate-y-0.5 hover:shadow-lg dark:border-yellow-500/40 dark:from-yellow-500/15 dark:to-yellow-600/10 ${selected ? 'ring-2 ring-primary' : ''}`}
    ...
    >
      ...
      <div className='px-3 pb-3'>
        <div className='line-clamp-4 text-xs whitespace-pre-wrap text-muted-foreground'>
