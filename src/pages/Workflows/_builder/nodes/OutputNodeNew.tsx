...
export default function OutputNodeNew({ selected, data }: NodeProps) {
  const response: string | null = (data as OutputNodeData)?.response ?? null
    ...
    >
      <CardHeader className='pb-2'>
        <CardTitle className='flex items-center gap-2 text-sm text-card-foreground'>
          <div className='rounded bg-green-600/90 p-1'>
