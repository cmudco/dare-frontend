...
export const getStatusDisplay = (status: FileStatus) => {
    switch (status) {
        case FileStatus.PROCESSING:
            return <Badge variant="secondary"><Loader2 className="w-4 h-4 animate-spin mr-1" /> Processing</Badge>;
        case FileStatus.PROCESSED:
            return <Badge variant="green"><CheckCircle className="w-4 h-4 mr-1" /> Processed</Badge>;
